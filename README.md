...
The repository with the compiled game, contains two modified files. These two files originates from the mentioned game server. The first file is hub.js, and is necessary to run the game. 
